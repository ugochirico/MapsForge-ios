...
@implementation OrgKxml2KdomElement

J2OBJC_IGNORE_DESIGNATED_BEGIN
- (instancetype)init {
  OrgKxml2KdomElement_init(self);
  return self;
}
...
- (OrgKxml2KdomElement *)createElementWithNSString:(NSString *)namespace_
  ...
  return (self->parent_ == nil) ? [super createElementWithNSString:namespace_ withNSString:name] : [((OrgKxml2KdomNode *) nil_chk(self->parent_)) createElementWithNSString:namespace_ withNSString:name];
}
...
- (OrgKxml2KdomNode *)getRoot {
  OrgKxml2KdomElement *current = self;
  while (current->parent_ != nil) {
    if (!([current->parent_ isKindOfClass:[OrgKxml2KdomElement class]])) return current->parent_;
    current = (OrgKxml2KdomElement *) cast_chk(current->parent_, [OrgKxml2KdomElement class]);
  }
  return current;
}
...
- (NSString *)getNamespaceUriWithNSString:(NSString *)prefix {
  ...
  return [parent_ isKindOfClass:[OrgKxml2KdomElement class]] ? [((OrgKxml2KdomElement *) nil_chk(((OrgKxml2KdomElement *) cast_chk(parent_, [OrgKxml2KdomElement class])))) getNamespaceUriWithNSString:prefix] : nil;
}
...
- (void)parseWithOrgXmlpullV1XmlPullParser:(id<OrgXmlpullV1XmlPullParser>)parser {
  ...
  if ([parser isEmptyElementTag]) [parser nextToken];
    ...
    if ([self getChildCount] == 0) [self addChildWithInt:OrgKxml2KdomNode_IGNORABLE_WHITESPACE withId:@""];
  }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[22].selector = @selector(setParentWithOrgKxml2KdomNode:);
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "parent_", "LOrgKxml2KdomNode;", .constantValue.asLong = 0, 0x4, -1, -1, -1, -1 },
    { "prefixes_", "LJavaUtilVector;", .constantValue.asLong = 0, 0x4, -1, -1, -1, -1 },
  };
  static const void *ptrTable[] = { "init", "createElement", "LNSString;LNSString;", "getAttributeNamespace", "I", "getAttributeName", "getAttributeValue", "getNamespaceUri", "LNSString;", "getNamespacePrefix", "parse", "LOrgXmlpullV1XmlPullParser;", "LJavaIoIOException;LOrgXmlpullV1XmlPullParserException;", "setAttribute", "LNSString;LNSString;LNSString;", "setPrefix", "setName", "setNamespace", "setParent", "LOrgKxml2KdomNode;", "write", "LOrgXmlpullV1XmlSerializer;", "LJavaIoIOException;", "namespace" };
  static const J2ObjcClassInfo _OrgKxml2KdomElement = { "Element", "org.kxml2.kdom", ptrTable, methods, fields, 7, 0x1, 24, 5, -1, -1, -1, -1, -1 };
  return &_OrgKxml2KdomElement;
}

@end

void OrgKxml2KdomElement_init(OrgKxml2KdomElement *self) {
  OrgKxml2KdomNode_init(self);
}

OrgKxml2KdomElement *new_OrgKxml2KdomElement_init() {
  J2OBJC_NEW_IMPL(OrgKxml2KdomElement, init)
}

OrgKxml2KdomElement *create_OrgKxml2KdomElement_init() {
  J2OBJC_CREATE_IMPL(OrgKxml2KdomElement, init)
}

J2OBJC_CLASS_TYPE_LITERAL_SOURCE(OrgKxml2KdomElement)
